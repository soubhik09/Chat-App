...
function SettingsPage() {
  ...
  return (
    <div className="h-screen min-h-fit container mx-auto px-4 pt-20 max-w-5xl pb-10">
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-2">
          {allThemes.map((e) => (
            ...
            >
              <div
                className="relative h-8 w-full rounded overflow-hidden"
                data-theme={e}
              >
                    ...
                    <div className="bg-base-100 rounded-xl shadow-sm overflow-hidden">
                        ...
                        <div className="p-4 space-y-4 min-h-[200px] max-h-[200px] overflow-y-auto bg-base-100">
                          {previewMessages.map((message)=>(
                            <div key={message.id} className={`flex ${message.isSent ? "justify-end" : "justify-start"}`}>
                                <div className={`max-w-[80%] rounded-xl p-3 shadow-sm ${message.isSent ? "bg-primary" : "bg-base-200"}`}>
                        ...
                        <div className="p-4 border-t border-base-300 bg-base-100">
                          <div className="flex gap-2">
                            <input
                              type="text"
                              className="input focus:input-primary focus:outline-none flex-1 text-1 text-sm h-10"
